/*! jPlayerPlaylist for jPlayer 2.9.2 ~ (c) 2009-2014 Happyworm Ltd ~ MIT License */ ! function(a, b) {
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function(b) {
            ...
            return d += "<a href='" + b.link + "'><h4 class='source'></h4></a><a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + b.title + "</a>" + (b.intro ? " <div class='dek'><p class='jp-intro'><strong>Intro:</strong> " + b.intro + "<p>" + b.dek + "</p>" +"</p></div>" : ""), d += "</div></li>"
        },
